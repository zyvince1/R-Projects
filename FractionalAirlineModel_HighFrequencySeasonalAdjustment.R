...
# Main script
ic_df <- read_preprocess_data("your_file_name.xlsx", "df")

# ********** set the following two variables to the beginning of your data history c(year,nth week of the year) **********
# for example, my data starts from the 1st week of year 1987, hence c(1987,1)
